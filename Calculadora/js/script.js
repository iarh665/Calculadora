...
function actualizarDisplay() {
    document.getElementById("display").textContent = valorEnPantalla;
}
        ...
        switch(operador){
            ...
            case "/":
                if(operando2 !== 0){
                    ...
                    document.getElementById("display").innerHTML="No se puede dividir entre 0!!!";
                    return;
                }
            default:
                return;       
